...
| **Episode Mining** | Frequent sequential patterns | Thesis's MV-Span + MT-Span ported in `src/Mining/Episodes.jl`; PrefixSpan (Pei 2001), SPADE (Zaki 2001), CM-SPADE (Fournier-Viger 2014) ported in `src/Mining/Baselines.jl`; Transformer attention-motif mining still TODO |
